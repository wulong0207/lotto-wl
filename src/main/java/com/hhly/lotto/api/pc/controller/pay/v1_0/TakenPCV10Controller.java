...
@RestController
@RequestMapping("/pc/v1.0/taken")
public class TakenPCV10Controller extends BaseController {

	private static final Logger logger = Logger.getLogger(TakenPCV10Controller.class);
