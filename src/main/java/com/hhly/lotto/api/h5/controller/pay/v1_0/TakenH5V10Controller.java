...
@RestController
@RequestMapping("/h5/v1.0/taken")
public class TakenH5V10Controller extends BaseController {

	private static final Logger logger = Logger.getLogger(TakenH5V10Controller.class);
