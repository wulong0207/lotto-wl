package com.hhly.lotto.api.h5.controller.home.v1_0;
 ...
 */
@RestController
@RequestMapping("/h5/v1.0/home")
public class HomeH5V10Controller extends HomeCommonV10Controller{
	private static final Logger LOGGER = Logger.getLogger(HomeH5V10Controller.class);
	@Autowired
	...
	public Object findMobialHome(OperateVO vo,HttpServletRequest request) {
		...
		Short platFrom =PlatFormEnum.WAP.getValue();
