package com.hhly.lotto.api.pc.controller.num.ssq.v1_0;
...
import com.hhly.lotto.api.common.controller.num.ssq.v1_0.SsqV10Controller;
 ...
 */
@RestController
@RequestMapping("/pc/v1.0/ssq")
public class SsqPcV10Controller extends SsqV10Controller {


	/**
	 * @desc PC端接口：双色球：查询彩种、当彩期、最新开奖详情、注/倍数配置、子玩法、限号
	 * @author huangb
	 * @date 2017年3月6日
	 * @return PC端接口：双色球：查询彩种、当彩期、最新开奖详情、注/倍数配置、子玩法、限号
	 */
	@RequestMapping(value = "/info", method = RequestMethod.GET)
	public Object findSsq(HttpServletRequest request) {
		logger.debug("PC端接口:双色球:查询彩种、当彩期、最新开奖详情、注/倍数配置、子玩法、限号");
