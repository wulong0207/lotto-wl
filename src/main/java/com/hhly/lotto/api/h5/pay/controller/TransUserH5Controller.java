 ...
 */
@RestController
@RequestMapping("/h5/trans")
public class TransUserH5Controller extends BaseController {

	private static final Logger logger = Logger.getLogger(TransUserH5Controller.class);
