package com.hhly.lotto.api.common.controller.area.ssl;
 ...
 * @version
 */
public abstract class SslV10Controller extends HighV10Controller {
	@Autowired
	protected ISslTrendService sslTrendService;
	...
	public Object findDrawColdHotOmit(LotteryVO param) throws Exception {
		...
		return sslTrendService.findDrawColdHotOmit(param);
	}
