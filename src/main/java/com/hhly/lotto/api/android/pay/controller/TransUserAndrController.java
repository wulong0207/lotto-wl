 ...
 */
@RestController
@RequestMapping("/android/trans")
public class TransUserAndrController extends BaseController {

	private static final Logger logger = Logger.getLogger(TransUserAndrController.class);
