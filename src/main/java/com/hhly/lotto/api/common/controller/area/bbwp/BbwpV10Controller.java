package com.hhly.lotto.api.common.controller.area.bbwp;
 ...
 * @version
 */
public abstract class BbwpV10Controller extends HighV10Controller {
	@Autowired
	protected IBbwpTrendService bbwpTrendService;
	...
	public Object findDrawColdHotOmit(LotteryVO param) throws Exception {
		...
		return bbwpTrendService.findDrawColdHotOmit(param);
	}
