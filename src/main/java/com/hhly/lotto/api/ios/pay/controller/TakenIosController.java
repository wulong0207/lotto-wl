...
@RestController
@RequestMapping("/ios/taken")
public class TakenIosController extends BaseController {

	private static final Logger logger = Logger.getLogger(TakenIosController.class);
