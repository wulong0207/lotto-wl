package com.hhly.lotto.api.android.controller.home.v1_0;
 ...
 */
@RestController
@RequestMapping("/android/v1.0/home")
public class HomeAndroidV10Controller extends HomeCommonV10Controller{
	private static final Logger LOGGER = Logger.getLogger(HomeAndroidV10Controller.class);
	@Autowired
	...
	protected Short getMobilePlatForm() {
		return MobailPlatFormEnum.ANDROID.getValue();
	}
}