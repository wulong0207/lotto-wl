...
public class DltPcController extends DltController {

	private static Logger logger = Logger.getLogger(DltPcController.class);
	...
	public Object findDlt() {
		logger.debug("PC端接口:大乐透:查询彩种、当彩期、最新开奖详情、注/倍数配置、子玩法、限号");
