 ...
 */
@RestController
@RequestMapping("/ios/trans")
public class TransUserIosController extends BaseController {

	private static final Logger logger = Logger.getLogger(TransUserIosController.class);
