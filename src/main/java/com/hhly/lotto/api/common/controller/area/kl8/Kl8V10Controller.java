package com.hhly.lotto.api.common.controller.area.kl8;
 ...
 * @version
 */
public abstract class Kl8V10Controller extends HighV10Controller {
	@Autowired
	protected IKl8TrendService kl8TrendService;
	...
	public Object findDrawColdHotOmit(LotteryVO param) throws Exception {
		...
		return kl8TrendService.findDrawColdHotOmit(param);
	}
