...
@RestController
@RequestMapping("/ios/v1.0/taken")
public class TakenIosV10Controller extends BaseController {

	private static final Logger logger = Logger.getLogger(TakenIosV10Controller.class);
