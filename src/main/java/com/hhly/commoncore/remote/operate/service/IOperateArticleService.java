...
public interface IOperateArticleService {	
	 ...
	 * 查询资讯详细信息并更新阅读数量
	 */
	ResultBO<OperateArticleLottBO> findArticleFromLott(OperateArticleLottVO articleVO);
	
	/**
	 * 查询手机端资讯首页内容信息
	 */
	ResultBO<MobialNewsHomeBO> findMobialNewsHome(String typeCode,short platFrom,String token);
