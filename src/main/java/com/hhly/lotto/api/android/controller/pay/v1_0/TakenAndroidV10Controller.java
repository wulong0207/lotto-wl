...
@RestController
@RequestMapping("/android/v1.0/taken")
public class TakenAndroidV10Controller extends BaseController {

	private static final Logger logger = Logger.getLogger(TakenAndroidV10Controller.class);
