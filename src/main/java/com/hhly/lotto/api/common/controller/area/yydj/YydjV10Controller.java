package com.hhly.lotto.api.common.controller.area.yydj;
 ...
 * @version
 */
public abstract class YydjV10Controller extends HighV10Controller {
	@Autowired
	protected IYydjTrendService yydjTrendService;
	...
	public Object findDrawColdHotOmit(LotteryVO param) throws Exception {
		...
		return yydjTrendService.findDrawColdHotOmit(param);
	}
