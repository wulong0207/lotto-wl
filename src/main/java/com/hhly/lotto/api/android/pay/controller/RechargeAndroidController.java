package com.hhly.lotto.api.android.pay.controller;
 ...
 */
@RestController
@RequestMapping("/android/rechargeCenter")
public class RechargeAndroidController extends BaseController {
	@Resource
	...
	*/
	...
	public Object toRecharge(HttpServletRequest request) throws Exception {
		return rechargeComponent.toRecharge(request, PayConstants.TakenPlatformEnum.ANDROID);
	}
	...
	*/
	...
	public Object findRechargeRed(@RequestBody RechargeInputParamVO rechargeInputParam) throws Exception {
		rechargeInputParam.setPlatformEnum(PayConstants.TakenPlatformEnum.ANDROID);
	...
	*/
	...
	public Object recharge(@RequestBody RechargeInputParamVO rechargeInputParam, HttpServletRequest request) throws Exception {
		return rechargeComponent.recharge(rechargeInputParam, getIp(request), PayConstants.TakenPlatformEnum.ANDROID);
	}
