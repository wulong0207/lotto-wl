 ...
 */
@RestController
@RequestMapping("/ios/v1.0/trans")
public class TransUserIosV10Controller extends BaseController {

	private static final Logger logger = Logger.getLogger(TransUserIosV10Controller.class);
	...
	*/
	...
	public Object takenList(HttpServletRequest request) {
		...
		TransParamVO transParam = (TransParamVO) resultBO.getData();
		try {
			transParam.setPlatform(PayConstants.TakenPlatformEnum.IOS.getKey());
	...
	* @return: Object 
	*/
	@RequestMapping(value = "/takenDetail", method = RequestMethod.GET)
