...
@RestController
@RequestMapping("/android/taken")
public class TakenAndroidController extends BaseController {

	private static final Logger logger = Logger.getLogger(TakenAndroidController.class);
