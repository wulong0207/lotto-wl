...
@RestController
@RequestMapping("/android/payCenter")
public class PayAndroidController extends BaseController {
	...
	*/
	...
	public Object toPay(HttpServletRequest request) throws Exception {
		return payComponent.toPay(request, PayConstants.TakenPlatformEnum.ANDROID);
	}
	...
	*/
	...
	public Object toBatchPay(@RequestBody ToPayInputParamVO toPayInputParamVO) throws Exception {
		return payComponent.toBatchPay(toPayInputParamVO, PayConstants.TakenPlatformEnum.ANDROID);
	}
	...
	*/
	...
	public Object pay(@RequestBody PayInputParamVO payInputParam, HttpServletRequest request) throws Exception {
		return payComponent.pay(payInputParam, getIp(request), PayConstants.TakenPlatformEnum.ANDROID);
	}
