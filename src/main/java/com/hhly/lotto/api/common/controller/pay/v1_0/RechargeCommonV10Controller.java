 ...
 */
@RestController
@RequestMapping("/v1.0/rechargeCenter")
public class RechargeCommonV10Controller extends BaseController {
	private static final Logger logger = Logger.getLogger(RechargeCommonV10Controller.class);
	...
	*/
	...
	public ModelAndView lianReturn(@PathVariable("noOrder") String noOrder, @PathVariable("platform") String platform, @PathVariable("isActivity") String isActivity) throws Exception {
		...
		if ("0".equals(isActivity)) {// 非活动
			switch (platform) {
			case "1":
				viewUrl = lianWebPayUrl + "result/pay-success?tc=" + noOrder;
				break;
			case "2":
			case "3":
			case "4":
