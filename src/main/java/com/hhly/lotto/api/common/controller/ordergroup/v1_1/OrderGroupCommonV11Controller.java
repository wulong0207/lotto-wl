package com.hhly.lotto.api.common.controller.ordergroup.v1_1;
...
public class OrderGroupCommonV11Controller extends BaseController {

    private static Logger logger = LoggerFactory.getLogger(OrderGroupCommonV11Controller.class);
    ...
    public ResultBO<?> queryOrderGroupList(@RequestBody OrderGroupQueryVO orderGroupQueryVO, HttpServletRequest request)throws Exception{
        ...
        ResultBO<?> result = iOrderGroupService.queryOrderGroupListV11(orderGroupQueryVO);
